...
    height: 720,
    webPreferences: {
      // ✅ Configuración correcta de Precarga y Seguridad
...
// Se ha eliminado el código que define 'contextBridge', 'ipcRenderer', 'api' y 'contextBridge.exposeInMainWorld'.
// Este código solo pertenece al archivo 'preload.js' y causaba el error en el Proceso Principal.
...
      cwd: engineDirAbs,
      shell: false,
      detached: true, // Esto es clave para el process.kill(-pid)
      windowsHide: true,
